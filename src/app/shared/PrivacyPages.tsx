...
export const PrivacyPolicy = () => (
    <PageWrapper
      ...
      content={`
        <p class="text-xl font-semibold mb-6">Effective Date: April 21, 2025</p>
        
        <p class="mb-6">At ChartFlow AI, we prioritize your privacy and are committed to maintaining the trust you place in us. This Privacy Policy outlines our practices regarding the collection, use, and protection of your information.</p>
        
        <h2 class="text-2xl font-semibold mt-8 mb-4">Information We Collect</h2>
        
        <p class="mb-4">We collect only the minimum data necessary to provide and improve our services:</p>
        <ul class="list-disc pl-6 mb-6 space-y-2">
          <li>Account information (email address, name, and professional details)</li>
          <li>Usage data (how you interact with our platform)</li>
          <li>Technical data (device information, IP address, and browser type)</li>
          <li>Content you create and store on our platform</li>
        </ul>
        ...
        <p class="mb-6">You maintain control over your data. You can:</p>
        <ul class="list-disc pl-6 mb-6 space-y-2">
          <li>Access, update, or delete your personal information</li>
          <li>Opt out of non-essential communications</li>
          <li>Disable analytics tracking through your account settings</li>
          <li>Request a copy of your data</li>
        </ul>
        
        <p class="mb-6">We never sell your personal information to third parties. Your trust is our priority.</p>
        
        <p class="italic mt-8">By continuing to use ChartFlow AI, you acknowledge that you have read and understood this Privacy Policy.</p>
      `}
    />
  );
